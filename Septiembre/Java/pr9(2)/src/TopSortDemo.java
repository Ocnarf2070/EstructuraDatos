...
public class TopSortDemo {
    public static void main(String[] args) {
        ...
        // choose graph
        DiGraph<Integer> g = g3; // g1, g2, g3

        System.out.println(g);

        TopologicalSortingDic<Integer> topSort = new TopologicalSortingDic<Integer>(g);
        if (!topSort.hasCycle())
            System.out.println("A topological sorting: " + topSort.order());
        else
            System.out.println("DiGraph is cyclic ");

        TopologicalSortingDicPar<Integer> topSortPar = new TopologicalSortingDicPar<Integer>(g);
