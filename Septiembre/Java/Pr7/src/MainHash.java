...
public class MainHash {
	...
	static void oneTest(int seed) {
		...
		scHashTable.delete(10);
		lpHashTable.delete(10);
		System.out.println(scHashTable.toString());
		System.out.println(lpHashTable.toString());
		/*System.out.println(lpHashTable.isEmpty());
		System.out.println(lpHashTable.search(1));
		int m = 16, n = 1;
		System.out.println("Is "+ n +" in the table? sc->"+(scHashTable.isElem(n))+" lp->"+(lpHashTable.isElem(n)));
		System.out.println("Is "+m+" in the table?sc->"+(scHashTable.isElem(m))+" lp->"+(lpHashTable.isElem(m)));
		*/
