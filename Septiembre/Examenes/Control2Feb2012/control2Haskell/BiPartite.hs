...
aux g dict stack
	...
	| colored ver == False = aux g (D.insert ver color dict) (pushAll (S.pop stack) [(ver',nextColor color) | ver' <- successors g ver])
	| colored ver == True && D.valueOf' ver dict == color = aux g dict (S.pop stack)
	| otherwise = Nothing
-- 
